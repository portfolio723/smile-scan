...
import { Upload, AlertCircle, Timer, Smile, ShieldCheck } from "lucide-react";
    ...
    <Card className="p-6 md:p-10 flex flex-col gap-8 shadow-xl border-border animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div
        ...
        className={cn(
          ...
          "hover:shadow-[0_0_20px_rgba(210,144,50,0.1)]"
        )}
      >
        <input
          type="file"
        ...
        <div className="text-center">
          <p className="text-lg font-semibold text-foreground">Upload your smile</p>
          <p className="text-sm text-muted-foreground">Drag & drop or choose a photo</p>
        </div>

        <Button className="mt-2 bg-blue-600 hover:bg-blue-700 text-white" size="lg">
          Select Image
        </Button>
      </div>
